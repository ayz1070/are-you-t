...
PostResponseDto _$PostResponseDtoFromJson(Map<String, dynamic> json) =>
    PostResponseDto(
      ...
      likeCount: (json['likesCount'] as num?)?.toInt() ?? 0,
      commentCount: (json['commentsCount'] as num?)?.toInt() ?? 0,
...
Map<String, dynamic> _$PostResponseDtoToJson(PostResponseDto instance) =>
    <String, dynamic>{
      ...
      'likesCount': instance.likeCount,
      'commentsCount': instance.commentCount,
